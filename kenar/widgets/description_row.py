...
class DescriptionRow(BaseModel, BaseWidget):
    ...
    def check_preview_max_line(self) -> Self:
        ...
        if expandable_ is False and preview_max_line_ > 0:
            raise ValueError('Can not set preview_max_line when field expandable is set to False')
        return self

    def serialize_model(self) -> dict:
        return {
            "widget_type": "DESCRIPTION_ROW",
            "data": {"@type": "type.googleapis.com/widgets.DescriptionRowData"} | self.model_dump(),
        }
